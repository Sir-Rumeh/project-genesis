...
function darkModeStart() {
  ...
  document.getElementById("lightModeId").classList.add("transitionDarkMode1");
...
function lightModeStart() {
  document.getElementById("lightModeId").classList.add("transitionLightMode1");
  document.getElementById("lightModeId").innerHTML = "Light Mode";
  document.getElementById("darkModeId").classList.remove("transitionDarkMode2");
...
function openPage() {
  ...
  if (x === "facebook") {
    window.open("https://www.flaticon.com/search?word=facebook&type=icon");
  }
}